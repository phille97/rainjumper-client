...
public class ServerSelectionScene extends Scene {
	...
	public ServerSelectionScene(Game game, Scene goTo, ArrayList<Entity> entities, Dimension screenSize, Color bgColor, Color buttonColor) {
		...
		enterUsername = new Button("Enter server IP:", this.buttonColor, this.buttonColor.darker(), (WIDTH/2)-150, (HEIGHT/2)-77, 300, 30);
		nameIF = new InputField("80.240.132.129", Color.WHITE, Color.DARK_GRAY, (WIDTH/2)-150, (HEIGHT/2)-50, 300, 30);
		okButton = new Button("Connect!", this.buttonColor, this.buttonColor.darker(), (WIDTH/2)-150, (HEIGHT/2), 300, 30);
	...
	public void keyTyped(KeyEvent e){
		if(nameIF.isMarked()) {
			if(e.getKeyCode() != KeyEvent.VK_BACK_SPACE){
				String text = "";
				text = "" + e.getKeyChar();
				if(Character.isDigit(e.getKeyChar()) || Character.isLetter(e.getKeyChar()) || e.getKeyChar() == '.'){
	...
	public void KeyPressed(int e){
		if(e == KeyEvent.VK_BACK_SPACE) {
			...
			this.game.setMultiplayerServer(this.nameIF.getContainingText());
